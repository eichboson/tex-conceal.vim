...
syn match texMathSymbol '\\A\a@!' contained conceal cchar=𝔸
syn match texMathSymbol '\\B\a@!' contained conceal cchar=𝔹
syn match texMathSymbol '\\C\a@!' contained conceal cchar=ℂ
syn match texMathSymbol '\\D\a@!' contained conceal cchar=𝔻
syn match texMathSymbol '\\E\a@!' contained conceal cchar=𝔼
syn match texMathSymbol '\\F\a@!' contained conceal cchar=𝔽
syn match texMathSymbol '\\G\a@!' contained conceal cchar=𝔾
syn match texMathSymbol '\\H\a@!' contained conceal cchar=ℍ
syn match texMathSymbol '\\I\a@!' contained conceal cchar=𝕀
syn match texMathSymbol '\\J\a@!' contained conceal cchar=𝕁
syn match texMathSymbol '\\K\a@!' contained conceal cchar=𝕂
syn match texMathSymbol '\\L\a@!' contained conceal cchar=𝕃
syn match texMathSymbol '\\M\a@!' contained conceal cchar=𝕄
syn match texMathSymbol '\\N\a@!' contained conceal cchar=ℕ
syn match texMathSymbol '\\O\a@!' contained conceal cchar=𝕆
syn match texMathSymbol '\\P\a@!' contained conceal cchar=ℙ
syn match texMathSymbol '\\Q\a@!' contained conceal cchar=ℚ
syn match texMathSymbol '\\R\a@!' contained conceal cchar=ℝ
syn match texMathSymbol '\\S\a@!' contained conceal cchar=𝕊
syn match texMathSymbol '\\T\a@!' contained conceal cchar=𝕋
syn match texMathSymbol '\\U\a@!' contained conceal cchar=𝕌
syn match texMathSymbol '\\V\a@!' contained conceal cchar=𝕍
syn match texMathSymbol '\\W\a@!' contained conceal cchar=𝕎
syn match texMathSymbol '\\X\a@!' contained conceal cchar=𝕏
syn match texMathSymbol '\\Y\a@!' contained conceal cchar=𝕐
syn match texMathSymbol '\\Z\a@!' contained conceal cchar=ℤ
