...
syn match texMathSymbol '\\AA\a\@!' contained conceal cchar=𝔸
syn match texMathSymbol '\\BB\a\@!' contained conceal cchar=𝔹
syn match texMathSymbol '\\CC\a\@!' contained conceal cchar=ℂ
syn match texMathSymbol '\\DD\a\@!' contained conceal cchar=𝔻
syn match texMathSymbol '\\EE\a\@!' contained conceal cchar=𝔼
syn match texMathSymbol '\\FF\a\@!' contained conceal cchar=𝔽
syn match texMathSymbol '\\GG\a\@!' contained conceal cchar=𝔾
syn match texMathSymbol '\\HH\a\@!' contained conceal cchar=ℍ
syn match texMathSymbol '\\II\a\@!' contained conceal cchar=𝕀
syn match texMathSymbol '\\JJ\a\@!' contained conceal cchar=𝕁
syn match texMathSymbol '\\KK\a\@!' contained conceal cchar=𝕂
syn match texMathSymbol '\\LL\a\@!' contained conceal cchar=𝕃
syn match texMathSymbol '\\MM\a\@!' contained conceal cchar=𝕄
syn match texMathSymbol '\\NN\a\@!' contained conceal cchar=ℕ
syn match texMathSymbol '\\OO\a\@!' contained conceal cchar=𝕆
syn match texMathSymbol '\\PP\a\@!' contained conceal cchar=ℙ
syn match texMathSymbol '\\QQ\a\@!' contained conceal cchar=ℚ
syn match texMathSymbol '\\RR\a\@!' contained conceal cchar=ℝ
syn match texMathSymbol '\\SS\a\@!' contained conceal cchar=𝕊
syn match texMathSymbol '\\TT\a\@!' contained conceal cchar=𝕋
syn match texMathSymbol '\\UU\a\@!' contained conceal cchar=𝕌
syn match texMathSymbol '\\VV\a\@!' contained conceal cchar=𝕍
syn match texMathSymbol '\\WW\a\@!' contained conceal cchar=𝕎
syn match texMathSymbol '\\XX\a\@!' contained conceal cchar=𝕏
syn match texMathSymbol '\\YY\a\@!' contained conceal cchar=𝕐
syn match texMathSymbol '\\ZZ\a\@!' contained conceal cchar=ℤ
